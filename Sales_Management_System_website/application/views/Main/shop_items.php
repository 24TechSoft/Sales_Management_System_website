							...
							<div class="right">
								...
								<div class="sett">
									<div class="att">
										...
										<div class="binn"><label id="cartcount"></label></div>
										</a>
									</div>
									<div class="log">
										<div class="dropdown">
				    ...
				    <div class="flexslider">
					    <ul class="slides">
                            <li>
								...
								<img src="<?php echo base_url();?>MainFiles/images/banner-1.jpg" alt="" />
							</li>
							<li>
							   <div class="extra">
								    <h4>Lorem Ipsum is simply dummy text !</h4>
								...
								<img src="<?php echo base_url();?>MainFiles/images/banner-2.jpg" alt="" />
							</li>
                            <li>
							    <div class="extra">
								    <h4>Lorem Ipsum is simply dummy text !</h4>
							...
							<div class="duct">
								...
								<div class="mainn">
									...
									<div class="cate">
										<ul>
											<form id="catform" method="post" action="<?php echo base_url();?>Shopping_Controller" >
												<li>All<button type="submit"><img src="<?php echo base_url();?>MainFiles/images/bttnn.png" alt=""/> </button></li>
											</form>
									...
									<div class="products">
										<!--search box starts-->
										<div class="search">
											<input type="text" placeholder="Search Anything You Want.." onchange="search();">
										</div>
										<!--search box ends-->
                                			<?php
											$Item=0;
										...
										<div class="bxtt">
											...
											if($open==1)
											{
												...
												<p><i class="fa fa-rupee"></i> <?php echo $row["Price"];?></p>	
												</div>
												<div class="pls">
													<div class="ltt">
														<h4>QTY:</h4>
													...
													<div class="rtt">
														<div class="count-input space-bottom" id="quantityref">
															...
															<input class="quantity" type="text" id="quantity<?php echo $row["ItemID"];?>" name="quantity" value="<?php echo $row["MinVendorQty"];?>"/>
															<input type="hidden" class="minVendorQty" value="<?php echo $row["MinVendorQty"];?>" />
												...
												<div class="add">
													...
													<?php } else { echo "Product out of stock!!"; }?>
