								...
								<div class="right">
								   ...
								   <h2>Sign Up</h2>
								    ...
								    <div class="otpp">
										   ...
										   <!--bottom part starts-->
										   <form id="signupform" method="post"  enctype="data/multipart">
										   ...
										   <div class="rbottom">
										      ...
										      <table >
											      ...
											      <tr><td><label>User Name : </label></td><td><input type="text" placeholder="Enter your Name" name="name" id="name" ></td></tr>
												   <tr><td><label>User ID: </label></td><td><input type="text" placeholder="Enter your User ID" name="userID" id="userID" ></td></tr>
												 <!--  <tr><td><label>Password: </label></td><td><input type="password" placeholder="Enter your Password" name="password" id="password" ></td></tr> -->
												<tr><td><label>Email ID : </label></td><td><input type="text" placeholder="Enter your Email ID" name="email" id="email" ></td></tr>
												
												<tr><td><label>Phone No : </label></td><td><input type="text" placeholder="Enter your Phone No" name="phone" id="phone" ></td></tr>
																		   
												<tr><td><label>Address :</label></td><td><textarea rows="4" cols="50" placeholder="Enter your Full Address" name="address" id="address"></textarea></td></tr>
											 ...
											 <div class="down">
												...
												<button  onclick="customer();" form="nameform" >Sign Up</button>
...
$(document).ready(function() {
	...
	function customer(){
		//alert('test');
		var url='<?php echo base_url();?>Login_Controller/addcustomer';
...
function login(){
	var url='http://localhost/agriculture-food/Login_Controller/login';
	//alert(url);
	var html="";
	$.ajax({
		url:url,
