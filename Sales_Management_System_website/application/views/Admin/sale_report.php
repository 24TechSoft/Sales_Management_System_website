                  ...
                  <div class="x_content">
                    ...
                    <form id="usermaster_form" enctype="multipart/form-data"  class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Sale Date: 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" class="btn btn-success" onclick="ordercheck();availableitem();">Search</button>
...
function ordercheck(){
	...
	var url="<?php echo base_url();?>Report_Controller/checksalestock";	
