              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="vendor_form" enctype="multipart/form-data" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
					   ...
					   <div class="form-group">
						...
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" id="eErr">Email ID is not valid!!</label>
					...
					<!--Address-->
					  <div class="form-group">
					   ...
					   <div class="form-group">
						...
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" id="addErr"> Address cannot be blank!!
					 ...
					 <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" id="pinErr">Pin Code cannot be blank!!</label>
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Vat 

                        </label>

                        <div class="col-md-6 col-sm-6 col-xs-12">

                          <input type="text" name="vat" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" onclick="AddVendors();" class="btn btn-success">Submit</button>
...
function AddVendors(){
	if(validate()){
		alert("abc");
		 var myForm = document.getElementById('vendor_form');

		 formData = new FormData(myForm);

		 var url='<?php echo base_url();?>CustomerMaster_Controller/Addvendormaster';
		alert(url);
		 $.ajax({
...
function DisplayCustomerMaster(){
	...
	var url="<?php echo base_url();?>CustomerMaster_Controller/ShowvendorMaster";
			...
			console.log(data);
			 $('#usertable').DataTable( {
					...
					{ "data": "ID","render": function ( data, type, full, meta ) {
						  return '<a href="<?php echo base_url();?>CustomerMaster_Controller/DeleteVendorMaster/'+data+'">Delete</a>';
						} },
					<?php } ?>
				],
