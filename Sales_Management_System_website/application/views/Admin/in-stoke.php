                  ...
                  <div class="x_content">
                    ...
                    <form id="stock_form" enctype="multipart/form-data"  class="form-horizontal form-label-left">
					  ...
					  <div class="form-group">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Warehouse <span class="required">*</span></label>
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Entry Date:  </label>
						...
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" id="dateErr"> Date: cannot be blank!! </label>
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Quantity <span class="required">*</span> </label>
