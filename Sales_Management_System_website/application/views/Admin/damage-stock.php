              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="damagestock_form" enctype="multipart/form-data"  class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Damage Date: 
						...
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" id="dateErr"> Date: cannot be blank!! 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" onclick="addDamageStock();" class="btn btn-success">Submit</button>
...
function addDamageStock(){ // passing down the event 
		if(validate()){

		 var myForm = document.getElementById('damagestock_form');

		 formData = new FormData(myForm);

		 var url="<?php echo base_url();?>DamageStock/AddInStock";
		 ...
		 $.ajax({
		   ...
		   success: function(){
			   ...
			   document.getElementById('damagestock_form').reset();
...
function ShowInStock(){
	...
	var url='<?php echo base_url(); ?>DamageStock/ShowInStock';
