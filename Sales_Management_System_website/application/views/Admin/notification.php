...
<html lang="en">
  ...
  <body class="nav-md">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <a <?php if($row["Type"]==1) { ?>href="<?php echo base_url();?>OrderMaster_Controller"<?php } 

				   else if($row["Type"]==2) {?> href="<?php echo base_url();?>BillMaster_Controller/bill_view"<?php } 

				   else if($row["Type"]==3) {?> href="<?php echo base_url();?>OrderMaster_Controller"<?php } 

				   else if($row["Type"]==4) {?> href="<?php echo base_url();?>Consignment/consignment_view"<?php } 

				   else if($row["Type"]==5) {?> href="<?php echo base_url();?>InStock"<?php } 

				   else if($row["Type"]==6) {?> href="<?php echo base_url();?>OutSock"<?php } 

				   else if($row["Type"]==7) {?> href="<?php echo base_url();?>DamageStock"<?php } 

				   else if($row["Type"]==8) {?> href="<?php echo base_url();?>ReturnStock"<?php } 

				   else if($row["Type"]==9) {?> href=""<?php }

				   ?>

				   

				   ><h2 onclick="updateNotiStat(<?php echo $row["ID"];?>)"><?php echo $row["Detail"];?></h2></a>
	...
	function updateNotiStat(ID){

		var url="<?php echo base_url();?>UserMaster/updateNotiStat/"+ID;
		...
		$.ajax({
			...
			error:function(){
				...
				//alert('Sorry notification not updated');
