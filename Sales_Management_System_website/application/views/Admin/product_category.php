              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="category_form" enctype="multipart/form-data" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" name="category" id="category" class="form-control col-md-7 col-xs-12">

                        </div>
						
						 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" id="catErr">Category Name cannot be blank!!</label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" onclick="AddCategory();" class="btn btn-success">Submit</button>
...
function AddCategory(){
		if(validate()){
			...
			var url='<?php echo base_url();?>Product_Package/AddCategory';
...
function DisplayCategory(){
	...
	var url='<?php echo base_url()?>Product_Package/DisplayCategory';
			...
			console.log(data);
			 $('#usertable').DataTable( {
					...
					{ "data": "ID","render": function ( data, type, full, meta ) {
						  return '<a href="<?php echo base_url();?>Product_Package/DeleteCategory/'+data+'">Delete</a>';
						} },
					<?php } ?>
