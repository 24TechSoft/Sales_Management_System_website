          ...
          <div class="">
			<div class="row">
			  <div class="col-md-4 col-xs-12">
				<form action="<?php echo base_url();?>AMR_VendorController/SaveArea" method="post">
					...
					<div class="form-group">
						...
						<input type="number" class="form-control" name="MinimumOrder" required>
					</div>
					<div class="form-group">
						<label>Delivery Charge</label>
						<input type="number" class="form-control" name="DeliveryCharge" required>
					</div>
              ...
              <div class="col-md-8 col-xs-12">
				<table id="datatable" class="table table-striped table-bordered dt-responsive nowrap">
					...
					<tbody>
						...
						<td><a href="<?php echo base_url();?>AMR_VendorController/DeleteArea?ID=<?php echo $row["ID"];?>" class="btn btn-info">Delete</a></td>
						</tr>
						<?php
						}
						?>
