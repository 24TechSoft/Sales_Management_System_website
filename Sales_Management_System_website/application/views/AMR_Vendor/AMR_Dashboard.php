      ...
      <div class="main_container">
		...
		<div class="row tile_count">
            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div class="count"><?php echo $TodaysOrder[0]["TotalValue"]; ?></div>
              <span class="count_bottom"><i class="green"><?php echo $TodaysOrder[0]["Total"]; ?></i> Orders</span>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top">This Month's Order</span>
              <div class="count"><?php echo $MonthOrder[0]["TotalValue"]; ?></div>
              <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i><?php echo $MonthOrder[0]["Total"]; ?></i> Orders</span>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top">Total Purchase of Month</span>
              <div class="count green"><?php echo $MonthPurchase[0]["TotalValue"]; ?></div>
              <span class="count_bottom"><i class="red"><i class="fa fa-sort-desc"></i><?php echo $MonthPurchase[0]["Total"]; ?></i> Purchase Bills</span>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top">Total Bills of Month</span>
              <div class="count"><?php echo $MonthBills[0]["TotalValue"]; ?></div>
              <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i><?php echo $MonthBills[0]["Total"]; ?></i> Bills</span>
            </div>
          </div>
          <div class="">
			<div class="row">
              <div class="col-md-12 col-xs-12">
				<table id="datatable" class="table table-striped table-bordered dt-responsive nowrap">
					...
					<tbody>
						...
						<td><?php if($row["PaymentStatus"]==1){echo "Paid";}else{echo "Unpaid";}?></td>
						<td><a href="<?php echo base_url();?>AMR_VendorController/OrderDetail<?php echo $row["ID"];?>" class="btn btn-info">Detail</a></td>
						</tr>
						<?php
						}
						?>
