...
<head>
	...
	<title>ABAD AGRO | ORDER DETAIL</title>
					...
					<div class="col-md-9 col-sm-8 col-xs-12">
						<div class="main-content-shop">
							<div class="product-grid-view">
								<div class="row">
								<h2 class="title18 title-widget font-bold text-center">Order Detail</h2>
									<div class="col-md-12 col-sm-12 col-xs-12 orderhead">
									<?php foreach($OrderDetail as $row){ ?>
										<div class="col-md-4 col-sm-6 col-xs-6">
											<label>Order Date:</label> <?php echo $row["OrderDate"]; ?></br>
											<label>Order No:</label> <?php echo $row["OrderCode"]; ?>
										</div>
										<div class="col-md-4 col-sm-6 col-xs-6">
											<label>Current Status:</label> <?php if( $row["Status"]==0) {?>Order Placed <?php }
										...
										else if($row["Status"]==4){?>Order Returned <?php }?></br>
											<label>Amount:</label> &#8377; <?php echo $row["GrandTotal"];?>
										</div>
										<div class="col-md-4 col-sm-6 col-xs-6">
											<label>No Of Items:</label> <?php echo $row["Items"];?></br>
											<label></label>
										</div>
										...
										<div class="col-md-4 col-sm-6 col-xs-6">
											<?php if($row["Status"]==2){?>
												<button class="btnn-clr" onclick="location.href='<?php echo base_url();?>Shopping/invoice/<?php echo $OrderID;?>'">Invoice</button>
											<?php } ?>
										</div>
										<div class="col-md-4 col-sm-6 col-xs-6">
									<button class="btnn-clr" onclick="location.href='<?php echo base_url();?>Shopping/tracking/<?php echo $OrderID;?>'">Track</button>
										</div>
										<div class="col-md-4 col-sm-6 col-xs-6">
										<?php if($row["Status"]==0){?>
											<button class="cancelor" onclick="location.href='<?php echo base_url();?>OrderMaster_Controller/cancelorder/<?php echo $OrderID;?>'">Cancel Order</button>
										<?php } ?>
										</div>
										</div>
									<?php } ?>
									...
									<div class="clearfix"></div>
									<div class="col-md-12 col-sm-12 col-xs-12 ordertable">
									...
									<div class="table-responsive">
										<table class="table ord">
											...
											<tbody>
											<?php $count=0; foreach($OrderItems as $item){ $count++;?>
												<tr>
													<td> <?php echo $count;?> </td>
													<td> <?php echo $item["ItemName"];?></td>
													<td><?php echo $item["PackageQuantity"];?> kg</td>
													<td> &#8377; <?php echo $item["PackagePrice"];?></td>
