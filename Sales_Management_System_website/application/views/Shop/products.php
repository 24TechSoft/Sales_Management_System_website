...
<head>
	...
	<title>ABAD AGRO | PRODUCTS</title>
...
<div class="wrap">
					...
					<nav class="main-nav main-nav1">
						<ul>
                           <!--pin code ends-->						
							...
							<li class="current-menu-item has-mega-menu"><a href="<?php echo base_url();?>Shopping/products/0">Products</a></li>
	...
	<section id="content">
		...
		<div class="container">			
			<!-- ENd Banner -->
			<div class="content-shop extar-paddj">
				<div class="row">
					...
					<div class="col-md-9 col-sm-8 col-xs-12">
						<div class="main-content-shop">
							<div class="shop-pagibar clearfix">
								<p class="desc silver pull-left"><?php echo sizeOf($Products);?> products found</p>
									...
									<div class="col-md-4 col-sm-6 col-xs-6">
										<div class="item-product item-product-grid text-center">
											<div class="product-thumb">
												<a href="<?php echo base_url();?>Shopping/productdetails/<?php echo $prod["ID"];?>" class="product-thumb-link rotate-thumb">
													<img src="<?php echo base_url();?>ItemPhoto/<?php echo $prod["Photo"];?>" alt="<?php echo $prod["Name"];?>">
													<img src="<?php echo base_url();?>ItemPhoto/<?php echo $prod["Photo"];?>" alt="<?php echo $prod["Name"];?>">
												</a>
												<a href="<?php echo base_url();?>Shopping/productdetails/<?php echo $prod["ID"];?>" class="quickview-link"><i class="fa fa-search" aria-hidden="true"></i></a>
											</div>
											<div class="product-info">
												<h3 class="product-title"><a href="product-details.html"><?php echo $prod["Name"];?></a></h3>
												<div class="product-price">
													<ins class="color"><span>&#8377; <?php echo $prod["CurrentPrice"];?></span></ins>
												</div>
