...
<head>
	...
	<title>ABAD AGRO | PRODUCT DETAIL</title>
	...
	<section id="content">
		<div class="container">
			<div class="shop-banner banner-adv line-scale zoom-image">
				<a href="#" class="adv-thumb-link"><img src="<?php echo base_url();?>Main/images/product-details.jpg" alt="" /></a>
				<div class="banner-info">
					<h2 class="title30 color">Shop</h2>
					<div class="bread-crumb white"><a href="<?php echo base_url();?>Shopping" class="white">Home</a><span>Product Detail</span></div>
				</div>
			</div>
			<!-- ENd Banner -->
							...
							<div class="row">
								<div class="col-md-6 col-sm-12 col-xs-12">
									<div class="detail-gallery">
										<div class="mid">
											<img src="<?php echo base_url();?>ItemPhoto/<?php echo $prod["Photo"];?>" alt=""/>
										</div>
									</div>
									<!-- End Gallery -->
								</div>
								<div class="col-md-6 col-sm-12 col-xs-12">
									<div class="detail-info">
										<h2 class="title30 font-bold"><?php echo $prod["Name"];?></h2>
										<div class="product-rate">
											<div class="product-rating" style="width:100%"></div>
										</div>
										<p class="desc"><?php echo $prod["ItemDescription"];?></p>
										
										<div class="sort-bar extra-padddk">
											<div class="select-box border radius6 inline-block">
												<select class="radius6" id="packages">
												<?php foreach($prod["Packages"] as $pack) {?>
													<option value="<?php echo $pack["ProductID"];?>"><?php echo $pack["PackageName"]." -  Rs.".$pack["ProductPrice"];?></option>
												<?php }?>
												</select>
											</div>
										</div>
										<ul class="list-inline-block wrap-qty-extra">
											<li>
												<div class="detail-qty">
													...
													<?php foreach($prod["Packages"] as $pack) {?>
													<input type="hidden" class="qtyval" value="<?php echo $pack["MinVendorQty"];?>"/>
													<span class="qty-val"><?php echo $pack["MinVendorQty"];?></span>
													
													<input type="hidden" class="qty" value="<?php echo $pack["MinVendorQty"];?>" id="qty<?php echo $prod["ID"];?>" />
													<?php } ?>
											...
											<li>
												...
												<?php if($prod["Quantity"]!=NULL){ ?>
													<a onclick="addcart(<?php echo $prod["ID"];?>);" class="addcart-link">Add to cart</a>
												<?php } else { ?>
												<p class="redify">Product Out Of Stock!</p><?php } ?>
												</div>
											</li>
										</ul>
										<p class="desc info-extra">
											<label>Category:</label><a href="#" class="color"><?php echo $prod["Category"];?></a>
										</p>
										...
										<ul class="list-none list-tags-review">
											<li>
												<div class="review-author">
													<a href="#"><img src="<?php echo base_url();?>Main/images/shop/author1.jpg" alt=""></a>
												</div>
											...
											<li>
												<div class="review-author">
													<a href="#"><img src="<?php echo base_url();?>Main/images/shop/author2.jpg" alt=""></a>
												</div>
												<div class="review-info">
													<p class="review-header"><a href="#"><strong>7up-theme</strong></a> – March 30, 2017:</p>
													<div class="product-rate">
...
function addcart(id){
	...
	var url='<?php echo base_url();?>Shopping/addcart/'+id;
