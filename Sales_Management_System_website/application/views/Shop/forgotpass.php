...
<head>
	...
	<title> ABAD AGRO | FORGOT PASSWORD </title>
			...
			<div class="container">
				<div class="shop-banner banner-adv line-scale zoom-image">
					...
					<div class="banner-info">
						<h2 class="title30 color">Forgot Password</h2>
						<div class="bread-crumb white"><a href="<?php echo base_url();?>Shopping" class="white">Home</a><span>Forgot Password</span></div>
					</div>
				</div>
				<!-- ENd Banner -->
				<div class="content-cart-checkout woocommerce">
					<h2 class="title30 font-bold text-uppercase text-center">Forgot Password</h2>
					<div class="row">
									  ...
									  <div class="col-sm-6">
									       ...
									       <div class="login-main">
										       ...
										       <div class="middl">
											      ...
											      <p>Please enter your email address. We will send you an link to your email and registered mobile number</p>
											   
											   </div>
											   
											   <div class="call">
											       <form>
												        <input type="text" placeholder="Enter email ID" id="emailotp" />
												   </form>
												   
												   <a class="mini-cart-view shop-button" onclick="sendOTP();">Set Password</a>
...
function sendOTP(){
	var url="<?php echo base_url();?>Login_Controller/forgotpassword";
	...
	$.ajax({
		...
		success:function(response){
			alert(response);
			//swal("Link has been sent to your mail");
		}
	});
}	
