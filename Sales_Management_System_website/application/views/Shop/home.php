...
<div class="wrap">
						   ...
						   <li class="pin">
							   <div class="mini-cart-box mini-cart1 pull-right">
									<a class="mini-cart-link" href="">
										...
										<span class="mini-cart-number"><span class="color">Search Your Pin code..</span></span>
								     </a>
												...
												<div class="mini-cart-button">
													...
													<a class="mini-cart-checkout shop-button" href="#">Search</a>
												</div>
											</div>
										</div>
	...
	<section id="content">
		<div class=" banner-slider banner-slider1 bg-slider">
			<div class="wrap-item owl-carousel owl-theme" data-transition="fade" data-pagination="false" data-navigation="true" data-itemscustom="[[0,1]]" data-autoplay="true">
				
				<!--slider starts-->

				<div class="item-slider item-slider1">
					<div class="banner-thumb"><a href="#"><img src="<?php echo base_url();?>Main/images/slide3.jpg" alt="" /></a></div>
					<div class="banner-info animated" data-animated="bounceIn">
						<div class="text-center white text-uppercase">
							...
							<h4 class="title18"> when you purchase 2 or more items*</h4>
				...
				<div class="item-slider item-slider1">
					<div class="banner-thumb"><a href="#"><img src="<?php echo base_url();?>Main/images/slide2.jpg" alt="" /></a></div>
					<div class="banner-info animated" data-animated="bounceIn">
						<div class="text-center white text-uppercase">
							<h3 class="title30">fruit Oraganic food</h3>
							<h2 class="title120 font-bold animated" data-animated="flash">big sale</h2>
							<h4 class="title18">up to 30% off on all products</h4>
							<a href="#" class="btn-arrow white">Shop now</a>
						</div>
					</div>
				</div>
				...
				<div class="item-slider item-slider1">
					...
					<div class="banner-info animated" data-animated="bounceIn">
						<div class="text-center white text-uppercase">
							...
							<h2 class="title120 font-bold animated" data-animated="flash">up to <span class="title90">35% off</span></h2>
							<h4 class="title18">limited quantities only in the first week of September</h4>
							<a href="#" class="btn-arrow white">Shop now</a>
						</div>
					</div>
				</div>
						...
						<aside class="sidebar-left sidebar-shop">
							...
							<div class="widget widget-category">
								...
								<ul class="list-none wg-list-cat">
									...
									<li><a href="<?php echo base_url();?>Shopping/products/<?php echo $rowcat["ID"];?>"><?php echo $rowcat["Category"];?></a><span class="color"><?php echo $rowcat["items"];?></span></li>
									<?php } ?>
					...
					<div class="col-md-9 col-sm-8 col-xs-12">
						<div class="main-content-shop">
							...
							<div class="shop-pagibar clearfix">
								...
								<p class="desc silver pull-left">Showing 12 results</p>
									...
									<div class="col-md-4 col-sm-6 col-xs-6">
										<div class="item-product item-product-grid text-center">
											<div class="product-thumb">
												<a href="<?php echo base_url();?>Shopping/productdetails/<?php echo $item["ItemID"];?>" class="product-thumb-link rotate-thumb">
													<img src="<?php echo base_url();?>ItemPhoto/<?php echo $item["Photo"];?>" alt="<?php echo $item["Name"];?>">
													<img src="<?php echo base_url();?>ItemPhoto/<?php echo $item["Photo"];?>" alt="<?php echo $item["Name"];?>">
												</a>
												<a href="<?php echo base_url();?>Shopping/productdetails/<?php echo $item["ItemID"];?>" class="quickview-link "><i class="fa fa-search" aria-hidden="true"></i></a>
											</div>
											<div class="product-info">
												<h3 class="product-title"><a href="product-details.html"></a></h3>
												<div class="product-price">
													<ins class="color"><span>&#8377; <?php echo $item["Price"];?></span></ins>
												</div>
											</div>
										</div>
									</div>
		...
		<div class="featured-product">
			<div class="container">
				<h2 class="title30 font-bold title-box1 text-center">Featureds Products</h2>
				<div class="featured-product-slider">
					<div class="wrap-item group-navi" data-autoplay="true" data-navigation="true" data-pagination="false" data-itemscustom="[[0,1]]">
						<div class="item-product-featured">
							<div class="row">
								<div class="col-md-5 col-sm-5 col-xs-12">
									<div class="product-thumb border">
										<a href="detail.html" class="product-thumb-link rotate-thumb">
											<img src="<?php echo base_url();?>Main/images/img-1.jpg" alt="">
											<img src="<?php echo base_url();?>Main/images/img-2.jpg" alt="">
										</a>
						...
						<div class="item-product-featured">
							<div class="row">
								<div class="col-md-5 col-sm-5 col-xs-12">
									<div class="product-thumb border">
										<a href="detail.html" class="product-thumb-link rotate-thumb">
											<img src="<?php echo base_url();?>Main/images/img-3.jpg" alt="">
											<img src="<?php echo base_url();?>Main/images/img-4.jpg" alt="">
										</a>
										<a href="quick-view.html" class="quickview-link fancybox fancybox.iframe"><i class="fa fa-search" aria-hidden="true"></i></a>
									</div>	
								</div>
						...
						<div class="item-product-featured">
							<div class="row">
								<div class="col-md-5 col-sm-5 col-xs-12">
									<div class="product-thumb border">
										<a href="detail.html" class="product-thumb-link rotate-thumb">
											<img src="<?php echo base_url();?>Main/images/img-5.jpg" alt="">
				...
				<div class="row">
				  ...
				  <div class="col-sm-12">
					...
					<div class="col-sm-6">
						<div class="list-diet custom-scroll">
							<div class="item-diet table">
								<div class="diet-thumb"><a href="#"><img src="<?php echo base_url();?>Main/images/dd-1.png" alt="" /></a></div>
								<div class="diet-info">
							...
							<div class="item-diet table">
								<div class="diet-thumb"><a href="#"><img src="<?php echo base_url();?>Main/images/dd-2.png" alt="" /></a></div>
								<div class="diet-info">
							...
							<div class="item-diet table">
								<div class="diet-thumb"><a href="#"><img src="<?php echo base_url();?>Main/images/dd-3.png" alt="" /></a></div>
								<div class="diet-info">
					...
					<div class="col-sm-6">
							...
							<p class="desc">You've heard of Superfoods, but…Superfruits? Not every fruit qualifies. Those deemed "super" by nutrition scientists are packed with antioxidants, fiber, vitamins and minerals, and other nutrients that can help you live longer, look better, and even prevent disease.</p>
							
							<p class="desc">You've heard of Superfoods, but…Superfruits? Not every fruit qualifies. Those deemed "super" by nutrition scientists are packed with antioxidants, fiber, vitamins and minerals, and other nutrients that can help you live longer, look better, and even prevent disease.</p>
							
							<p class="desc">You've heard of Superfoods, but…Superfruits? Not every fruit qualifies. Those deemed "super" by nutrition scientists are packed with antioxidants, fiber, vitamins and minerals, and other nutrients that can help you live longer, look better, and even prevent disease.</p>
							
							<p class="desc">You've heard of Superfoods, but…Superfruits? Not every fruit qualifies. Those deemed "super" by nutrition scientists are packed with antioxidants, fiber, vitamins and minerals</p>
					...
					<div class="slick center">
						<div class="item-client">
							<div class="client-thumb">
								<a href="#"><img src="<?php echo base_url();?>Main/images/testomonial-1.png" alt="" /></a>
							</div>
							<div class="client-info">
								...
								<h3 class="title18"><a href="#" class="black">Lorem Ipsum 1</a></h3>
								<span class="color">CEO / Founder</span>
							</div>
						</div>
						<div class="item-client">
							<div class="client-thumb">
								<a href="#"><img src="<?php echo base_url();?>Main/images/testomonial-2.png" alt="" /></a>
							</div>
							<div class="client-info">
								<p class="desc">“Morbi condimentum egestas quam, tempus ornare tortor. Vivamus ultricies gravida elit, sit amet interdum odio fringilla consequatSed quis condimentum quamorbi condimentum egestas quam, tempus ornare tortor.”</p>
								<h3 class="title18"><a href="#" class="black">Lorem Ipsum 2</a></h3>
								<span class="color">CEO / Founder</span>
							</div>
						</div>
						<div class="item-client">
							<div class="client-thumb">
								<a href="#"><img src="<?php echo base_url();?>Main/images/testomonial-3.png" alt="" /></a>
							</div>
							<div class="client-info">
								<p class="desc">“Morbi condimentum egestas quam, tempus ornare tortor. Vivamus ultricies gravida elit, sit amet interdum odio fringilla consequatSed quis condimentum quamorbi condimentum egestas quam, tempus ornare tortor.”</p>
								<h3 class="title18"><a href="#" class="black">Lorem Ipsum 3</a></h3>
								<span class="color">CEO / Founder</span>
							</div>
						</div>
						<div class="item-client">
							...
							<div class="client-info">
								<p class="desc">“Morbi condimentum egestas quam, tempus ornare tortor. Vivamus ultricies gravida elit, sit amet interdum odio fringilla consequatSed quis condimentum quamorbi condimentum egestas quam, tempus ornare tortor.”</p>
								<h3 class="title18"><a href="#" class="black">Lorem Ipsum 4</a></h3>
								<span class="color">CEO / Founder</span>
							</div>
						</div>
						<div class="item-client">
							...
							<div class="client-info">
								<p class="desc">“Morbi condimentum egestas quam, tempus ornare tortor. Vivamus ultricies gravida elit, sit amet interdum odio fringilla consequatSed quis condimentum quamorbi condimentum egestas quam, tempus ornare tortor.”</p>
								<h3 class="title18"><a href="#" class="black">Lorem Ipsum 5</a></h3>
								<span class="color">CEO / Founder</span>
							</div>
						</div>
						<div class="item-client">
							...
							<div class="client-info">
								<p class="desc">“Morbi condimentum egestas quam, tempus ornare tortor. Vivamus ultricies gravida elit, sit amet interdum odio fringilla consequatSed quis condimentum quamorbi condimentum egestas quam, tempus ornare tortor.”</p>
								<h3 class="title18"><a href="#" class="black">Lorem Ipsum 6</a></h3>
								<span class="color">CEO / Founder</span>
							</div>
						</div>
					</div>
