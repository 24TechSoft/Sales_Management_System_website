					...
					<div class="row">
						...
						<div class="col-md-5 col-sm-5 col-xs-12">
								...
								<ul class="info-account list-inline-block pull-right">
									...
									<a href="">
										...
										<span class="mini-cart-number"><span class="color"><?php foreach($Vendor as $ven) echo $ven["Name"];?></span></span>
												...
												<div class="main-kk">
													...
													<div class="prfff-mini table">
														<div class="jkkl">
															<a href="<?php echo base_url();?>Login_Controller">Logout</a>
									...
									<?php } else {?>
									<li><a href="<?php echo base_url();?>Login_Controller/logout"><i class="fa fa-key"></i></span>Login</a></li>
									<?php } ?>
					...
					<div class="col-md-9 col-sm-8 col-xs-12">
						...
						<div class="main-content-shop">
							<div class="product-grid-view">
								...
								<div class="row">
								<h2 class="title18 title-widget font-bold">My Information</h2>
									<div class="col-md-12 col-sm-12 col-xs-12">
									<?php foreach($Vendor as $ven){?>
										<form class="form-my-account" onSubmit="return validate();" method="post" action="<?php echo base_url();?>Shopping/updatevendor/<?php echo $ven["ID"];?>">
											<label>Name: <?php echo $ven["Name"];?></label>
											</br>
											</br>
											<label>Phone Number:</label>
											<input type="text" name="phone" value="<?php echo $ven["Phone"];?>"/>
											
											<label>Email ID</label>
											<input type="email" name="email" value="<?php echo $ven["Email"];?>"/>
											
											<label>VAT</label>
											<input type="text" name="vat" value="<?php echo $ven["Vat"];?>"/>
											
											<p>Address</p>
											<p><input type="text" value="<?php if($ven["Address1"]=="") echo "Address1"; else echo $ven["Address1"];?>" name="addr1" <?php if($ven["Address1"]=="") { ?> onblur="if (this.value=='') this.value = this.defaultValue" onfocus="if (this.value==this.defaultValue) this.value = ''" <?php } ?>/></p>
											<p><input type="text" value="<?php if($ven["Address2"]=="") echo "Address2"; else echo $ven["Address2"];?>" name="addr2" <?php if($ven["Address2"]=="") { ?> onblur="if (this.value=='') this.value = this.defaultValue" onfocus="if (this.value==this.defaultValue) this.value = ''" <?php } ?>/></p>
											<p><input type="text" value="<?php if($ven["City"]=="") echo "City"; else echo $ven["City"];?>" name="city" <?php if($ven["City"]=="") { ?> onblur="if (this.value=='') this.value = this.defaultValue" onfocus="if (this.value==this.defaultValue) this.value = ''" <?php } ?>/></p>
											<p><input type="text" value="<?php if($ven["Landmark"]=="") echo "Landmark"; else echo $ven["Landmark"];?>" name="landmark" <?php if($ven["Landmark"]=="") { ?> onblur="if (this.value=='') this.value = this.defaultValue" onfocus="if (this.value==this.defaultValue) this.value = ''" <?php } ?>/></p>
											<p class="clearfix box-col2">
												<input type="text" value="<?php if($ven["PinCode"]=="") echo "PinCode"; else echo $ven["PinCode"];?>" name="pincode" <?php if($ven["PinCode"]=="") { ?> onblur="if (this.value=='') this.value = this.defaultValue" onfocus="if (this.value==this.defaultValue) this.value = ''" <?php } ?>/>
												<input type="text" value="<?php if($ven["State"]=="") echo "State"; else echo $ven["State"];?>" name="state" <?php if($ven["State"]=="") { ?> onblur="if (this.value=='') this.value = this.defaultValue" onfocus="if (this.value==this.defaultValue) this.value = ''" <?php } ?>/>
											</p>
