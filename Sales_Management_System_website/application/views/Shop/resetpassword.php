...
<head>
	...
	<title>ABAD AGRO | RESET PASSWORD</title>
							...
							<div class="product-grid-view">
								...
								<h2 class="title18 title-widget font-bold">Change Password</h2>
									<div class="col-md-12 col-sm-12 col-xs-12">
										<form class="form-my-account" onSubmit="return validate();" method="post" action="<?php echo base_url();?>Login_Controller/passwordchange/<?php echo $OTP;?>">
