		...
		<div class="content-page">
			<div class="container">
				...
				<div class="content-cart-checkout woocommerce">
					<h2 class="title30 font-bold text-uppercase text-center">Create an account</h2>
					<div class="row">
								...
								<div class="col-sm-12">
									  ...
									  <div class="col-sm-6">
									       ...
									       <div class="login-main">
											   ...
											   <div class="call">
											       <form method="post" action="<?php echo base_url();?>Shopping/addvendor" onSubmit="return validate();">
														<input type="text" name="name" placeholder="Vendor Name" required>
														
														<input type="email" name="email" placeholder="Vendor Email" required>
														
														<input type="text" name="phone" placeholder="Vendor Phone Number" required>
												        <input type="text" name="username" placeholder="User Name" required>
														<input type="password" name="password" id="userpass" placeholder="Password" required>
														<input type="password" id="cuserpass" placeholder="Confirm Password" required>
											   ...
											   <div class="neww">
											       ...
											       <a href="<?php echo base_url();?>Login_Controller">Already have an account <a href="<?php echo base_url();?>Login_Controller">Login</a></a>
