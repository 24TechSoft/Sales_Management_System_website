...
<head>
	...
	<title>ABAD AGRO | ORDER TRACKING</title>
				...
				<div class="row">
					...
					<div class="col-md-9 col-sm-8 col-xs-12">
						...
						<div class="main-content-shop">
							<div class="product-grid-view trahhh">
							
								<div class="row">
								
								<h2 class="title18 title-widget font-bold text-center">Tracking</h2>
								
								<?php foreach($Consignment as $rowcon){ ?>
									<div class="col-md-12 col-sm-12 col-xs-12">
										<label>Order No:</label> <?php echo $rowcon["OrderCode"];?>
									</div>
									<div class="col-md-12 col-sm-12 col-xs-12">
										...
										<div class="progress">
											...
											<div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:100%; background:#5bc0de; color:#fff;">
										   
												<p><?php echo $rowcon["Remarks"];?></p>
									 ...
									 <?php } else if($rowcon["StatusID"]==3) { ?>	
										...
										<div class="progress">
											...
											<div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:60%; background:#F0F010; color:#fff;">
									 ...
									 <?php } else if($rowcon["StatusID"]==4) { ?>		
										...
										<div class="progress">
											...
											<div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:100%; background:#F0F010; color:#fff;">
									...
									<?php } else if($rowcon["StatusID"]==5) { ?>		
										...
										<div class="progress">
											...
											<div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:85% ; background:#3fe43f;">
										...
										<?php } else if($rowcon["StatusID"]==7) { ?>		
										
										<div class="progress">
										
											<div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:100% ; background:#FF5B5B;">
                                              <p><?php echo $rowcon["Remarks"];?></p>
								...
								<?php } ?>
									...
									<div class="table-responsive">
										<table class="table ord">
											...
											<tbody>
											<?php foreach($ConsignmentDetail as $row){ ?>
												<tr>
