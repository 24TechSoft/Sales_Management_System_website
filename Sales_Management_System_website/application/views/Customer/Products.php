...
<head>
	...
	<title>Abad Agro Organic Store | Products</title>
					...
					<div class="col-md-9 col-sm-8 col-xs-12">
						<div class="main-content-shop">
							<div class="product-grid-view">
								...
								{
								?>
								<h3>No Items are there in this category</h3>
								<?php
								}
								?>
								<div class="row">
									...
									<div class="col-md-4 col-sm-6 col-xs-6">
										<div class="item-product item-product-grid text-center">
											<div class="product-thumb">
												<a href="<?php echo base_url();?>AMR_Home/ProductDetail/<?php echo $row["ItemID"];?>" class="product-thumb-link rotate-thumb">
													<img src="<?php echo base_url();?>ItemPhoto/<?php echo $row["Photo"];?>" alt="">
													<img src="<?php echo base_url();?>ItemPhoto/<?php echo $row["Photo"];?>" alt="">
												</a>
												<a href="<?php echo base_url();?>AMR_Home/ProductDetail/<?php echo $row["ItemID"];?>" class="quickview-link "><i class="fa fa-search" aria-hidden="true"></i></a>
											</div>
											<div class="product-info">
												<h3 class="product-title"><a href="<?php echo base_url();?>AMR_Home/ProductDetail/<?php echo $row["ItemID"];?>"><?php echo $row["ItemName"];?></a></h3>
												<div class="product-price">
