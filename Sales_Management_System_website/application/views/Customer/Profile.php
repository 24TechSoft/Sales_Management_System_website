...
<head>
	...
	<title>Abad Agro Organic Store | My Profile</title>
	...
	function ValidateForm()
	{
		...
		{
			swal("Error","Email ID or Phone No must be full up","error");
			return false;
		}
		else
		{
			...
			<div class="content-shop">
				<div class="row">
					...
					<div class="col-md-9 col-sm-8 col-xs-12">
						<form method="post" action="<?php echo base_url();?>AMR_Customer/UpdateProfile" onsubmit="return ValidateForm();">
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label>Name</label>
									<input type="text" name="Name" id="Name" value="<?php echo $Profile[0]["Name"];?>" readonly class="form-control">
								</div>
								<div class="form-group">
									<label>User ID</label>
									<input type="text" name="UserID" id="UserID" value="<?php echo $Profile[0]["UserID"];?>" readonly class="form-control">
								</div>
								<div class="form-group">
									<label>Address</label>
									<textarea name="Address" id="Address" class="form-control"><?php echo $Profile[0]["Address"];?></textarea>
								</div>
								<div class="form-group">
									<label>Pin Code</label>
									<input type="number" name="PinCode" id="PinCode" value="<?php echo $Profile[0]["PinCode"];?>" class="form-control">
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label>Phone No</label>
									<input type="number" name="PhoneNo" id="PhoneNo" value="<?php echo $Profile[0]["PhoneNo"];?>" class="form-control">
								</div>
								<div class="form-group">
									<label>Email ID</label>
									<input type="email" name="EmailID" id="EmailID" value="<?php echo $Profile[0]["Email"];?>" class="form-control">
								</div>
							</div>
