...
<head>
	...
	<title>Abad Agro Organic Store | Log In</title>
									       ...
									       <div class="login-main">
										       ...
										       <div class="middl">
											       ...
											       <div class="fbbb">
												      ...
												      <a href="<?php echo $this->facebook->login_url(); ?>"><img src="<?php echo base_url();?>Customer_Main/images/fb-login.png" alt="facebook Login"/></a> 
												   
												   </div>
												   
												   <!--div class="gplss">
												   
												       <a href=""><img src="<?php echo base_url();?>Customer_Main/images/plus-login.png" alt="Google Plus Login"/></a> 
											   ...
											   <div class="call">
											       ...
											       <form method="post" action="<?php echo base_url();?>AMR_Customer/Login">
														...
														<button type="submit" class="mini-cart-view shop-button">Login</button>
												   </form>
											   ...
											   <div class="neww">
											       ...
											       <a href="<?php echo base_url();?>AMR_Home/RegistrationPage">New to ABAD? <a href="<?php echo base_url();?>AMR_Home/RegistrationPage">Sign Up</a></a>
