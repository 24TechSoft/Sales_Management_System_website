...
<head>
	...
	<title>Abad Agro Organic Store | Registration</title>
	...
	function Validate()
	{
		...
		var hdUserID=document.getElementById("hdUserID").value;
		var Email=document.getElementById("Email").value;
		var hdEmail=document.getElementById("hdEmail").value;
		var Phone=document.getElementById("Phone").value;
		var hdPhone=document.getElementById("hdPhone").value;
		...
		{
			swal("Error","User ID cannot be empty","error");
			return false;
		}
		else if(Email.trim()=="")
		{
		...
		{
			swal("Error","Phone no cannot be empty","error");
			return false;
		}
		...
		{
			swal("Error","Confirm password must match password","error");
			return false;
		}
		...
		{
			swal("Oops...", "User ID already exist", "error");
			return false;
		}
		else if(hdEmail=="0")
		{
		...
		{
			swal("Oops...", "Phone No already exist", "error");
			return false;
		}
		else
		{
	...
	{
		var UserID=document.getElementById("UserID").value;
		var url="<?php echo base_url();?>AMR_Customer/CheckUserID";
		$.ajax({
			url: url,
			type: 'post',
			data: {"UserID": UserID},
			...
			success: function(response)
			{
				if(response.length>0)
				{
					...
					document.getElementById("lblUserID").innerHTML="User ID already exist. Please choose another";
				}
				else
				{
					document.getElementById("hdUserID").value="1";
					document.getElementById("lblUserID").innerHTML="Congrats. User ID available";
				}
			},
			error: function()
			{
	...
	function CheckEmail()
	{
		...
		var url="<?php echo base_url();?>AMR_Customer/CheckEmailID";
		$.ajax({
			url: url,
			type: 'post',
			...
			success: function(response)
			{
				if(response.length>0)
				{
					document.getElementById("hdEmail").value="0";
					document.getElementById("lblEmail").innerHTML="Email ID already exist. Please choose another";
				}
				else
				{
					document.getElementById("hdEmail").value="1";
					document.getElementById("lblEmail").innerHTML="Congrats. Email ID not registered yet";
				}
			},
			error: function()
			{
	...
	function CheckPhone()
	{
		...
		var url="<?php echo base_url();?>AMR_Customer/CheckPhoneNo";
		$.ajax({
			url: url,
			type: 'post',
			...
			success: function(response)
			{
				if(response.length>0)
				{
					document.getElementById("hdPhone").value="0";
					document.getElementById("lblPhone").innerHTML="Phone No already exist. Please choose another";
				}
				else
				{
					document.getElementById("hdPhone").value="1";
					document.getElementById("lblPhone").innerHTML="Congrats. Phone No not registered yet";
				}
			},
			error: function()
			{
		...
		<div class="content-page">
			<div class="container">
				...
				<div class="content-cart-checkout woocommerce">
					<h2 class="title30 font-bold text-uppercase text-center">Registration</h2>
					<div class="row">
									  ...
									  <div class="col-sm-6">
									       ...
									       <div class="login-main">
											   ...
											   <div class="call">
											       ...
											       <form method="post" action="<?php echo base_url();?>AMR_Customer/Register" onsubmit="return Validate();">
														<div class="form-group">
															<label>First Name</label>
															<input type="text" placeholder="First Name" name="FirstName" id="FirstName" required class="form-control">
														</div>
														<div class="form-group">
															<label>Last Name</label>
															<input type="text" placeholder="Last Name" name="LastName" id="LastName" required class="form-control">
														</div>
														<div class="form-group">
															<label>User Name</label>
															<input type="text" placeholder="User Name" name="UserID" id="UserID" onchange="CheckUserID();" required class="form-control">
															<input type="hidden" id="hdUserID" value="0">
															<label id="lblUserID"></label>
														</div>
														<div class="form-group">
															<label>Email ID</label>
															<input type="email" placeholder="Email ID" name="Email" id="Email" onchange="CheckEmail();" required class="form-control">
															<input type="hidden" id="hdEmail" value="0">
															<label id="lblEmail"></label>
														</div>
														<div class="form-group">
															<label>Phone No</label>
															<input type="number" placeholder="Phone No" name="Phone" id="Phone" onchange="CheckPhone();" required class="form-control">
															<input type="hidden" id="hdPhone" value="0">
														...
														<div class="form-group">
															...
															<input type="password" placeholder="Password" name="ConfirmPassword" id="ConfirmPassword" required class="form-control">
														</div>
														<button type="submit" class="mini-cart-view shop-button">Register</button>
												   </form>
											   ...
											   <div class="neww">
											       ...
											       <a href="<?php echo base_url();?>AMR_Home/LoginPage">Already have an account? <a href="<?php echo base_url();?>AMR_Home/LoginPage">Log In</a></a>
