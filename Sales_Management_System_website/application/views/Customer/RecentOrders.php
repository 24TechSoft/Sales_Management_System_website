...
<head>
	...
	<title>Abad Agro Organic Store | Recent Orders</title>
					...
					<div class="col-md-9 col-sm-8 col-xs-12">
						...
						<div class="row">
							<div class="col-md-2 col-sm-6 col-xs-6">
								<label>Order Code:</label><br><a href="<?php echo base_url();?>AMR_Customer/OrderDetail/<?php echo $row["ID"];?>"><?php echo $row["VOrderCode"];?></a>
							</div>
							<div class="col-md-2 col-sm-6 col-xs-6">
								<label>Order Date:</label><br><?php echo $row["OrderDate"];?>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-6">
								<label>Total Amount:</label><br><?php echo $row["GrandTotal"];?>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-6">
								<label>Payment Status:</label><br><?php if($row["PaymentStatus"]==1){echo "Paid";} else{ echo "Not Paid"; }?>
							</div>
							<div class="col-md-2 col-sm-6 col-xs-6">
						...
						<div class="row">
							<div class="col-md-4 col-sm-12 col-xs-12">
								<?php echo $item["ItemName"]."<br>".$item["PackageName"];?>
							</div>
							<div class="col-md-2 col-sm-4 col-xs-4">
								<?php echo $item["Price"];?>
							</div>
							<div class="col-md-2 col-sm-4 col-xs-4">
								x<?php echo $item["PackageQuantity"];?>
							</div>
							<div class="col-md-2 col-sm-4 col-xs-4">
						...
						<hr/>
						<?php
						foreach($row["DeliveryAddress"] as $Address)
						{
						?>
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<label>To</label><br>
								<?php echo $Address["ContactPerson"];?><br>
								<?php echo nl2br($Address["AddressLine1"]);?><br>
								<?php
								if($Address["AddressLine2"]!="")
								{
									echo nl2br($Address["AddressLine1"])."<br>";
								}
								?>
								<label>Location:</label><?php echo $Address["Location"];?><br>
								<label>City:</label><?php echo $Address["City"];?><br>
								<label>Pin Code:<?php echo $Address["PinCode"];?><br>
								<label>State:</label><?php echo $Address["State"];?><br>
								<label>Contact No:</label><?php echo $Address["ContactNo"];?><br>
							</div>
						</div>
						<?php
						}
