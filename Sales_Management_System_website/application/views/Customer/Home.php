...
<head>
	...
	<title>Abad Agro Organic Store</title>
		...
		<div class=" banner-slider banner-slider1 bg-slider">
			<div class="wrap-item owl-carousel owl-theme" data-transition="fade" data-pagination="false" data-navigation="true" data-itemscustom="[[0,1]]" data-autoplay="true">
				...
				<div class="item-slider item-slider1">
					<div class="banner-thumb"><a href="#"><img src="<?php echo base_url();?>Customer_Main/images/slide3.jpg" alt="" /></a></div>
					<div class="banner-info animated" data-animated="bounceIn">
						<div class="text-center white text-uppercase">
							<h3 class="title30">Best Quality Vegetables & Fruits</h3>
							<h2 class="title120 font-bold animated" data-animated="flash">100<span class="title90">% ORGANIC</span></h2>
							<h4 class="title18"> in affordable price</h4>
				...
				<div class="item-slider item-slider1">
					<div class="banner-thumb"><a href="#"><img src="<?php echo base_url();?>Customer_Main/images/slide2.jpg" alt="" /></a></div>
					<div class="banner-info animated" data-animated="bounceIn">
						<div class="text-center white text-uppercase">
							<h3 class="title30">Best Quality Vegetables & Fruits</h3>
							<h2 class="title120 font-bold animated" data-animated="flash">100<span class="title90">% ORGANIC</span></h2>
					...
					<div class="col-md-4 col-sm-4 col-xs-4">
						<div class="item-service1 table">
							...
							<div class="service-info">
								...
								<p class="desc">On order above &#8377;500.00</p>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4">
						<div class="item-service1 table">
							...
							<div class="service-info">
								<h3 class="title18"><a href="#" class="black">Quick Delivery</a></h3>
								<p class="desc">Delivery within 24 Hours</p>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4">
					...
					<div class="col-md-9 col-sm-8 col-xs-12">
						<div class="main-content-shop">
							<div class="product-grid-view">
								<div class="row">
									<h2>Recenty Added Items</h2>
									<?php
									foreach($RecentlyAdded as $row)
									{
									?>
									<div class="col-md-4 col-sm-6 col-xs-6">
										<div class="item-product item-product-grid text-center">
											<div class="product-thumb">
												<a href="<?php echo base_url();?>AMR_Home/ProductDetail/<?php echo $row["ID"];?>" class="product-thumb-link rotate-thumb">
													<img src="<?php echo base_url();?>ItemPhoto/<?php echo $row["Photo"];?>" alt="">
													<img src="<?php echo base_url();?>ItemPhoto/<?php echo $row["Photo"];?>" alt="">
												</a>
												<a href="<?php echo base_url();?>AMR_Home/ProductDetail/<?php echo $row["ID"];?>" class="quickview-link "><i class="fa fa-search" aria-hidden="true"></i></a>
											</div>
											<div class="product-info">
												<h3 class="product-title"><a href="<?php echo base_url();?>AMR_Home/ProductDetail/<?php echo $row["ID"];?>"><?php echo $row["Name"];?></a></h3>
												<div class="product-price">
													<ins class="color"><span>&#8377; <?php echo $row["CurrentPrice"];?></span></ins>
												</div>
												<!--select product div starts-->
												<div class="clearfix"></div>
												
												<div class="clearfix"></div>
												<!--select product div ends-->
								...
								<div class="row">
									<h2>Hottest Sellings</h2>
									<?php
									foreach($HotSellings as $row)
									{
									?>
									<div class="col-md-4 col-sm-6 col-xs-6">
										<div class="item-product item-product-grid text-center">
