...
<head>
	...
	<title>Abad Agro Organic Store | Order Detail</title>
						...
						<aside class="sidebar-left sidebar-shop">
							...
							<div class="widget widget-category">
								...
								<ul class="list-none wg-list-cat">
									<li><a href="<?php echo base_url();?>AMR_Customer/Profile">My Profile</a><span class="color"><i class="fa fa-user" aria-hidden="true"></i></span></li>
									<li><a href="<?php echo base_url();?>AMR_Customer/RecentOrders">My Orders</a><span class="color"><i class="fa fa-database" aria-hidden="true"></i></span></li>
									<li><a href="<?php echo base_url();?>AMR_Customer/ChangePassword">Change Password</a><span class="color"><i class="fa fa-wrench" aria-hidden="true"></i></span></li>
									<li><a href="<?php echo base_url();?>AMR_Customer/Logout">Logout</a><span class="color"><i class="fa fa-key" aria-hidden="true"></i></span></li>
								</ul>
							</div>
						</aside>
					</div>
					<div class="col-md-9 col-sm-8 col-xs-12">
						<div class="row">
							<div class="col-md-4 col-sm-6 col-xs-12">
								<label>Order ID:</label> <?php echo $OrderDetail[0]["ID"];?>
							</div>
							<div class="col-md-4 col-sm-6 col-xs-12">
								<label>Order Code:</label> <?php echo $OrderDetail[0]["VOrderCode"];?>
							</div>
							<div class="col-md-4 col-sm-6 col-xs-12">
								<label>Order Date:</label> <?php echo $OrderDetail[0]["OrderDate"];?>
							</div>
							<div class="col-md-4 col-sm-6 col-xs-12">
								<label>Total Items:</label> <?php echo $OrderDetail[0]["ItemQty"];?>
							</div>
							<div class="col-md-4 col-sm-6 col-xs-12">
								<label>Total Amount:</label> &#8377;<?php echo $OrderDetail[0]["TotalOrderValue"];?>
							</div>
							<div class="col-md-4 col-sm-6 col-xs-12">
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								...
								else if($OrderDetail[0]["Status"]==4)
								{
									echo "Order Canceled";
								}
								?>
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								<label>Payment Status:</label> <?php 
								if($OrderDetail[0]["PaymentStatus"]==0)
								{
									echo "Unpaid";
									if($OrderDetail[0]["Status"]==0)
									{
										?>
										<a href="<?php echo base_url();?>AMR_OrderController/MakePayment/<?php echo $OrderDetail[0]["ID"];?>" class="btn btn-success">Pay Now</a>
										<?php
									}
								}
								else
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								<label>Delivery Type:</label> <?php 
								if($OrderDetail[0]["DeliveryType"]==1)
								{
									echo "Home Delivery";
								}
								else
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								...
								{
								?>
								<a href="<?php echo base_url();?>AMR_OrderController/CancelOrder/<?php echo $OrderDetail[0]["ID"];?>" class="btn btn-danger">Cancel Order</a>
								<?php
								}
								?>
							</div>
						...
						<div class="row">
							...
							?>
							<div class="col-md-4 col-sm-6 col-xs-12">
								<?php echo $row["ItemName"]." - ".$row["PackageName"];?>
							</div>
							<div class="col-md-4 col-sm-6 col-xs-12">
								&#8377;<?php echo $row["Price"]." X ".$row["PackageQuantity"];?>
							</div>
							<div class="col-md-4 col-sm-6 col-xs-12">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<b><?php echo $DeliveryAddress[0]["ContactPerson"];?></b><br>
								<?php echo $DeliveryAddress[0]["AddressLine1"];?><br>
								<?php echo $DeliveryAddress[0]["AddressLine2"];?><br>
								<b>Location: </b><?php echo $DeliveryAddress[0]["Location"];?><br>
								<b>City: </b><?php echo $DeliveryAddress[0]["City"];?><br>
								<b>State: </b><?php echo $DeliveryAddress[0]["State"];?><br>
								<b>Pin Code: </b><?php echo $DeliveryAddress[0]["PinCode"];?><br>
								<b>Contact No: </b><?php echo $DeliveryAddress[0]["ContactNo"];?>
							</div>
						</div>
					</div>
				</div>
