...
<head>
	...
	<title>Abad Agro Organic Store | Change Password</title>
			...
			<div class="content-shop">
				<div class="row">
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<form method="post" action="<?php echo base_url();?>AMR_Customer/ChangePasswordDone" onsubmit="return Validate();">
							...
							<button class="btn-success btn" type="submit">Change Password</button>
						</form>
					</div>
...
function Validate()
{
	...
	if(OldPassword.trim()=="")
	{
		swal("Error","Old Password cannot be empty","error");
		return false;
	}
	...
	{
		swal("Error","Confirm Password cannot be empty","error");
		return false;
	}
	else if(NewPassword!=ConfirmPassword)
	{
		swal("Error","New Password and Confirm Password must match","error");
		return false;
	}
	else if(NewPassword.length<8)
	{
		swal("Error","Password must be at least of 8 character long","error");
		return false;
	}
	else
	{
